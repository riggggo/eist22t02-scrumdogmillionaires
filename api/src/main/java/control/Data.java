...
public class Data {
        ...
        private static final String RESTAURANTS_PATH = "api/src/main/java/data/restaurants.json";
        private static final String EMAIL_PATH = "api/src/main/java/data/email.json";
        private static final String RESERVATION_ID_PATH = "api/src/main/java/data/reservation_id.json";
